            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">General Report</h4>
                        @if (session('success'))
                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $customer_collection = Collection::where('customer_id', $customer->id)->pluck('amount');
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$customer_collection->count()}}</td>
                                        <td>{{number_format($customer_collection->sum(), 2, '.', ',')}}</td>
                                    </tr>
                                    @endif
                                    @endforeach
                    ...
                    <div class="modal-body">
                        <form class="modal-body" action="{{route('filterReport')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="start_date" class="form-control" value={{$today}} max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" id="date" aria-describedby="emailHelp" >
                            </div>
                            <div class="form-group">
                                <label for="station_name">End Date</label>
                                <input type="date" name="end_date" class="form-control" value={{$today}} max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" id="date" aria-describedby="emailHelp" >
                            </div>
                            {{-- <div class="form-group">
